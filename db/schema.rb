...
ActiveRecord::Schema.define(:version => 20100112200754) do
  ...
  create_table "items", :force => true do |t|
    t.string   "album_name",  :limit => 100, :default => ""
    t.string   "artist_name", :limit => 100, :default => ""
    t.date     "year"
    ...
    t.string   "description", :limit => 200, :default => ""
    t.string   "location",    :limit => 50,  :default => ""
